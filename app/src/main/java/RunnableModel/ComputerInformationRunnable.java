...
public class ComputerInformationRunnable implements PublicOneListMehtodInterface{
    private String id;
    private String name;
    PublicOneListInterface getData;
    public ComputerInformationRunnable( String id,String name){
        this.id=id;
        this.name=name;
    }
            ...
            public void run() {
                ...
                try{
                    ...
                    if(!id.equals("")&&!name.equals("")){
                        rpc.addProperty("ProID",id);
                        rpc.addProperty("ProName",name);
                    }
