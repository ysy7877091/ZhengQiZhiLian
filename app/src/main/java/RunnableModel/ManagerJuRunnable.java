...
public class ManagerJuRunnable implements PublicMethodInterface {
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try{
                    ...
                    // 调用的方法名称
                    String methodName = "Check_GUANLIJUINFO";
                    // EndPoint
                    String endPoint = Path.get_faGai_Url();
                    // SOAP Action
                    String soapAction = "http://tempuri.org/Check_GUANLIJUINFO";
                    ...
                    if(count1>0) {
                        ...
                        for (int i = 0; i < count1; i++) {
                            ...
                            pb.setManager_name(soapProvince.getProperty("GLJNAME").toString());
