...
public class Manager_ProblemSumRunnable implements PublicMethodInterface {
    private PublicInterface DataListener;
    private List<PublicBeen> list =new ArrayList<>();
    private String managerid;
    private String proID;
    public Manager_ProblemSumRunnable(String managerid,String proID){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try{
                    ...
                    Log.e("warn",managerid+"managerid");
                    ...
                    if(envelope.getResponse()!=null) {
                        ...
                        SoapObject soap1 = (SoapObject) soapProvince.getProperty("Check_ProblemResult");//获取整个数据
                        Log.e("warn",soapProvince.getProperty("Check_ProblemResult").toString());
                        ...
                        for(int i=0;i<soap1.getPropertyCount();i++){
                            ...
                            if(!soap2.getProperty("PRONAME").toString().equals("anyType{}")){
                                pb.setCompanyName(soap2.getProperty("PRONAME").toString());
                            }else {
                                pb.setCompanyName("");
                            }
                            ...
                            if(soap2.getProperty("LOGINNAME").equals("anyType{}")){
                                pb.setLogin_Name("");
                            }else{
                                pb.setLogin_Name(soap2.getProperty("LOGINNAME").toString());
                            }
