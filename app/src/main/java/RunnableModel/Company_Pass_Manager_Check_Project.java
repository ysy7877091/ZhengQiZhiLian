...
public class Company_Pass_Manager_Check_Project implements PublicMethodInterface {
    private PublicInterface DataListener;
    private List<PublicBeen> list =new ArrayList<>();
    private String managerid;
    private String proID;
    public Company_Pass_Manager_Check_Project(String managerid,String proID){
