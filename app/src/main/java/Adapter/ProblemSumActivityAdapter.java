...
public class ProblemSumActivityAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public ProblemSumActivityAdapter(Context context, List<PublicBeen> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // holder.image.setTag(list.get(position).getIMAGESOURCE());
        ...
        if(list.get(position).getProject_state().equals("0")){
            ...
            holder.ProblemSum_state.setTextColor(context.getResources().getColor(R.color.yl01));
